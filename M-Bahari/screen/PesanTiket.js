  ...
  _modalDewasa=()=>{
    ...
    if(this.state.ValueDewasa==0){
        ...
        if(this.state.cekTotalPenumpang-this.state.ValueInfant==0){
          this.setState({show_ringkasan:false, viewvisibleKelas:false,colorVIP: '#F4F0E5', colorEXE:'#F4F0E5',colorTxtVip:'#000', colorTxtEXE:'#000',ButtonStateHolder:true,bgcolor:'#fcfbf8'});
        }
      }
