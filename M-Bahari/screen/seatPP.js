...
Tampilseat = () =>{
  ...
  CekTiket = () =>{
    ...
    fetch('http://expressbahari.com/php_mobile/get_tiket.php', {
      ...
      body: JSON.stringify({
        no_reservasi:this.state.No_Reservasi2,
      })
    ...
    return (
     ...
     <Header style={{backgroundColor:'#3F81B5',}}>
      ...
      <Left>
       ...
       <Title style={{marginTop:15,fontFamily:'SourceSansProBold', fontSize:20,marginLeft:-50}}>   Pilih Kursi Pulang</Title>
       </View>
     </Header>
     ...
     <Footer style={{backgroundColor:'#3F81B5',}}>
         <Button transparent style={{width:'100%'}}  onPress={ () => this.simpan()}>
           <Body>
